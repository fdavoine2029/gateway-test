 ...
 */
final class Version20230704123632 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sklbl_of ADD CONSTRAINT FK_22C283A5E25CDC FOREIGN KEY (sklbl_order_id) REFERENCES sklbl_orders (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
