 ...
 */
final class Version20230724130124 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sklbl_sku DROP opt_data1, DROP opt_data2, DROP opt_data3, DROP opt_data4, DROP opt_data5, DROP opt_data6, DROP opt_data7, DROP opt_data8, DROP opt_data9, DROP opt_data10');
    }
}
