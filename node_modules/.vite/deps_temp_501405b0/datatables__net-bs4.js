...
jquery_dataTables_default.ext.renderer.pageButton.bootstrap = function(settings, host, idx, buttons, page, pages) {
  ...
  var activeEl;
  try {
    activeEl = (0, import_jquery2.default)(host).find(document.activeElement).data("dt-idx");
  } catch (e) {
  }
  attach(
    (0, import_jquery2.default)(host).empty().html('<ul class="pagination"/>').children("ul"),
    buttons
  );
  if (activeEl !== void 0) {
    (0, import_jquery2.default)(host).find("[data-dt-idx=" + activeEl + "]").trigger("focus");
  }
};
