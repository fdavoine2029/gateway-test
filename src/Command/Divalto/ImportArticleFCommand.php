...
#[AsCommand(
    name: 'Divalto:Import-articleF',
    description: 'Synchronisation des articles Divalto',
)]
class ImportArticleFCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $response = $httpClient->request('POST',$_ENV['HOST_API'].'/api/articlesF/import/' . $input->getArgument('dossier') . '/' . $input->getArgument('jalon'));
