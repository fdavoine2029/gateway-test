...
class DivaltoController extends AbstractController
{
    ...
    public function show(ManagerRegistry $doctrine,ARTRepository $artRepository, string $ref): JsonResponse
    {
        $article = $artRepository->findDivaltoArts($ref);
        if (!$article) {
